    ...
    <el-form ref="data-form" :inline="true" :rules="rules" label-position="left" :model="model">
      <div class="row" style="flex-wrap:nowrap;width:100%;">
        <div class="row middle-span col-span">
          ...
          <el-button v-if="!hiddenSearch" @click="submitForm" class="search-button" style="vertical-align:top">搜索</el-button>
          <el-button v-if="showResetButton" @click="resetForm" class="reset-button" style="vertical-align:top">重置</el-button>
